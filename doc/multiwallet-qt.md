...
In order to support loading of multiple wallets in ltx-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is ltx.cpp.
...
Changes to ltx.cpp
----------------------
ltx.cpp is the entry point into ltx-qt, and as such, will require some minor modifications to provide hooks for
