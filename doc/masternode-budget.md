...
Ltx now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<ltx_address\> \<monthly_payment_ltx\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ LTX, _12_ times over the course of a year totaling _24000_ LTX.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<ltx_address\> \<monthly_payment_ltx\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` LTX.
 ...
 * vote-many          - Vote on a Ltx initiative
 * vote-alias         - Vote on a Ltx initiative
 * vote               - Vote on a Ltx initiative/budget
