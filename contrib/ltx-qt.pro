...
RESOURCES += src/qt/ltx.qrc src/qt/ltx_locale.qrc

TRANSLATIONS += src/qt/locale/ltx_bg.ts \
                src/qt/locale/ltx_de.ts \
                src/qt/locale/ltx_en.ts \
                src/qt/locale/ltx_es.ts \
                src/qt/locale/ltx_fi.ts \
                src/qt/locale/ltx_fr.ts \
                src/qt/locale/ltx_it.ts \
                src/qt/locale/ltx_ja.ts \
                src/qt/locale/ltx_pl.ts \
                src/qt/locale/ltx_pt.ts \
                src/qt/locale/ltx_ru.ts \
                src/qt/locale/ltx_sk.ts \
                src/qt/locale/ltx_sv.ts \
                src/qt/locale/ltx_vi.ts \
                src/qt/locale/ltx_zh_CN.ts \
                src/qt/locale/ltx_zh_TW.ts
