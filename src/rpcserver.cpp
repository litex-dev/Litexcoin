...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Ltx features */
        {"ltx", "masternode", &masternode, true, true, false},
        {"ltx", "listmasternodes", &listmasternodes, true, true, false},
        {"ltx", "getmasternodecount", &getmasternodecount, true, true, false},
        {"ltx", "masternodeconnect", &masternodeconnect, true, true, false},
        {"ltx", "masternodecurrent", &masternodecurrent, true, true, false},
        {"ltx", "masternodedebug", &masternodedebug, true, true, false},
        {"ltx", "startmasternode", &startmasternode, true, true, false},
        {"ltx", "createmasternodekey", &createmasternodekey, true, true, false},
        {"ltx", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"ltx", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"ltx", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"ltx", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"ltx", "getmasternodescores", &getmasternodescores, true, true, false},
        {"ltx", "mnbudget", &mnbudget, true, true, false},
        {"ltx", "preparebudget", &preparebudget, true, true, false},
        {"ltx", "submitbudget", &submitbudget, true, true, false},
        {"ltx", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"ltx", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"ltx", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"ltx", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"ltx", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"ltx", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"ltx", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"ltx", "checkbudgets", &checkbudgets, true, true, false},
        {"ltx", "mnsync", &mnsync, true, true, false},
        {"ltx", "spork", &spork, true, true, false},
        {"ltx", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"ltx", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use ltxd, or the -server option to ltx-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> ltx-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:17991/\n";
}
