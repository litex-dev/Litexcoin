/* src/config/ltx-config.h.  Generated from ltx-config.h.in by configure.  */
/* src/config/ltx-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "litexcoin.io"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Ltx Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Ltx Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "ltx"
