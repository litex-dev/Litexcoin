...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a LTX address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and ltx: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Ltx"), this);
    aboutAction->setStatusTip(tr("Show information about Ltx"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for LTX"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your LTX addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified LTX addresses"));
    ...
    openAction->setStatusTip(tr("Open a LTX: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Ltx help message to get a list with possible LTX command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Ltx client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to LTX network", "", count));
}
...
{
    QString strTitle = tr("Ltx"); // default title
