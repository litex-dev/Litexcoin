...
#if defined(NDEBUG)
#error "LTX cannot be compiled without assertions."
#endif
...
int64_t GetBlockValue(int nHeight)
{
    ...
    if (nHeight < 50) {
      nSubsidy = 10000 * COIN;
    } else if (nHeight < 8561) {
      nSubsidy = 1 * COIN;
    } else if (nHeight < 46001) {
      nSubsidy = 150 * COIN;
    } else if (nHeight < 53201) {
      nSubsidy = 173 * COIN;
    } else if (nHeight < 60401) {
      nSubsidy = 198 * COIN;
    } else if (nHeight < 67601) {
      nSubsidy = 228 * COIN;
    } else if (nHeight < 74801) {
      nSubsidy = 251 * COIN;
    } else if (nHeight < 82001) {
      nSubsidy = 276 * COIN;
    } else {
        nSubsidy = 20 * COIN;
    }
