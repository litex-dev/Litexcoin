...
The Ltx project operates an open contributor model where anyone is
...
The following applies to code changes to the Ltx project, and is not to be
confused with overall LTX Network Protocol consensus changes.

Whether a pull request is merged into Ltx rests with the project merge
...
Patches that change LTX consensus rules are considerably more involved than
...
Where a patch set proposes to change the LTX consensus, it must have been
...
The project leader is the release manager for each Ltx release.
